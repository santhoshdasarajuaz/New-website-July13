...
export const nav: NavItem[] = [
  ...
  { label: "About", to: "/about" },
  {
    ...
    children: [
      ...
      { label: "Production Support", to: "/services/$slug", params: { slug: "production-support" } },
      ...
      { label: "API & Payment Integration", to: "/services/$slug", params: { slug: "api-integration" } },
    ],
  },
  {
    label: "Expertise",
  ...
  { label: "Training", to: "/training" },
  {
    ...
    children: [
      ...
      { label: "Data Engineering & Cloud", to: "/courses/$slug", params: { slug: "data-engineering-cloud" } },
      { label: "Software Testing & QA", to: "/courses/$slug", params: { slug: "software-testing-qa" } },
