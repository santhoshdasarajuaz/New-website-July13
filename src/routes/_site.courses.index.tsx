  ...
  head: () => ({
    meta: [
      { title: "Our Courses — Niaga Prestasi" },
      {
        name: "description",
        content:
          "HTD Model Courses and Upskill Training programs — hands-on, industry-relevant IT courses.",
      },
      { property: "og:title", content: "Courses — Niaga Prestasi" },
      {
        property: "og:description",
        content: "HTD and Upskill IT courses across AI, data, cloud and more.",
      },
    ...
    <Reveal>
      <div>
        <div className="flex items-center gap-3">
          <span
            className={`h-10 w-10 rounded-md text-white font-display font-bold flex items-center justify-center ${tagColor}`}
          >
            {tag}
          </span>
            ...
            >
              <div>
                ...
                <div className="mt-1 text-xs text-ink-soft flex items-center gap-3">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <Layers className="h-3 w-3" /> {c.modules} modules
                  </span>
                </div>
              </div>
