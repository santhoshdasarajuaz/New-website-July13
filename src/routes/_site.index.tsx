...
function HomePage() {
  return (
    <>
      ...
      {/* Stats band */}
      <section className="bg-navy-deep text-white pb-10">
        <Container className="relative">
          <Reveal>
            <div className="rounded-2xl border border-white/10 bg-white/3 backdrop-blur-sm grid grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-white/10">
              {company.stats.map((s) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal>
              <SectionHeader
                ...
                title={
                  <>
                    Your trusted <span className="text-royal">technology & talent</span> partner
                  </>
                }
            ...
            <Reveal delay={0.1}>
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-border shadow-2xl">
                  <img
                    src={bankingImg}
                    alt="Banking technology dashboards"
                    width={1280}
                    height={900}
                    loading="lazy"
                ...
                <div className="absolute -bottom-6 -left-6 rounded-xl bg-navy-deep text-white px-5 py-4 shadow-xl">
                  ...
                  <div className="text-xs text-white/70 max-w-[140px] leading-snug">
                  ...
                  >
                    <div className="aspect-video overflow-hidden relative">
                      ...
                      <div className="absolute bottom-4 left-4 flex items-center gap-2 text-white">
                        ...
                        <span className="text-xs uppercase tracking-wider text-cyan-accent font-semibold">
                          Expertise
                        </span>
                      </div>
                    </div>
      ...
      <section className="section-y bg-navy-deep text-white relative overflow-hidden">
        ...
        />
        <div
          className="absolute inset-0 bg-linear-to-r from-navy-deep via-navy-deep/95 to-navy-deep/60"
          aria-hidden="true"
        />
        <Container className="relative">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <Reveal key={c.title} delay={i * 0.05}>
                    <div className="h-full rounded-xl border border-white/10 bg-white/4 p-5 backdrop-blur">
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <Reveal>
              <div className="relative">
                <div
                  className="absolute -inset-3 rounded-2xl bg-linear-to-br from-cyan-accent/20 to-royal/20 blur-xl"
                  aria-hidden="true"
                />
                <img
                  src={trainingImg}
            ...
            <Reveal delay={0.1}>
              <SectionHeader
                ...
                title={
                  <>
                    Training & <span className="text-royal">HRDC programs</span>
                  </>
                }
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  },
                  {
                    ...
                    body: "Fully aligned with HRD Corp guidelines.",
                  },
      ...
      <section className="section-y bg-white">
        <Container>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Deep BNM compliance expertise",
                body: "Regulatory alignment across banking and insurance programs.",
              },
              {
                title: "Proven core banking track record",
                body: "Delivery on core, digital and payments platforms.",
              },
              {
                title: "Agile delivery with quality",
                body: "Fast, iterative delivery without sacrificing rigor.",
              },
              {
                title: "End-to-end support",
                body: "From analysis to build, test, deploy and operate.",
              },
            ].map((c, i) => (
              <Reveal key={c.title} delay={i * 0.05}>
            ...
            {[
              {
                step: "01",
                title: "Discover",
                body: "Domain-led discovery of business goals, constraints and compliance.",
              },
              {
                step: "02",
                title: "Design",
                body: "Solution architecture and delivery plan aligned to regulatory needs.",
              },
              {
                step: "03",
                title: "Deliver",
                body: "Agile squads shipping iteratively with QA and business analysts.",
              },
              {
                step: "04",
                title: "Operate",
                body: "SLA-backed support, monitoring and continuous improvement.",
              },
            ].map((s, i) => (
              <Reveal key={s.step} delay={i * 0.06}>
                <div className="relative h-full rounded-xl border border-white/10 bg-white/3 p-6 backdrop-blur">
